...
public class e_EditEvents {
    
    // 命名規則 : 類型 + 動作
    public static let NAME : String = "edit"
    ...
    public static let SEND_EDIT : String = "\(NAME)_send_edit"
    public static let SEND_EDIT_RESULT : String = "\(NAME)_send_edit_result"
}
